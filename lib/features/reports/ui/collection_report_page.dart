...
class CollectionReportPage extends StatelessWidget {
        ...
        return ListView(
          children: [
            ReportSummaryGrid(items: [
              ...
              MapEntry("Count", (l['summary']['totalCount'] ?? 0).toString()),
              MapEntry("Verified", formatCurrency(l['summary']['verifiedAmount'])),
              MapEntry("Pending", formatCurrency(l['summary']['pendingAmount'])),
            ]),
            if (list.isEmpty)
