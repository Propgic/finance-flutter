...
class OverdueReportPage extends StatelessWidget {
        ...
        return ListView(
          children: [
            ReportSummaryGrid(items: [
              MapEntry("Overdue Loans", (l['summary']['overdueCount'] ?? 0).toString()),
              MapEntry("Overdue Amount", formatCurrency(l['summary']['overdueAmount'])),
              MapEntry("Late Fees", formatCurrency(l['summary']['lateFees'])),
            ]),
            if (list.isEmpty)
