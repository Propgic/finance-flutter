        ...
        return ListView(
          children: [
            ReportSummaryGrid(items: [
              MapEntry("Accounts", (l['summary']['totalAccounts'] ?? 0).toString()),
              MapEntry("Balance", formatCurrency(l['summary']['totalBalance'])),
              MapEntry("Deposits", formatCurrency(l['summary']['totalDeposits'])),
              MapEntry("Withdrawals", formatCurrency(l['summary']['totalWithdrawals'])),
            ]),
            if (list.isEmpty)
