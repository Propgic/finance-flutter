...
class InvestmentReportPage extends StatelessWidget {
        ...
        return ListView(
          children: [
            ReportSummaryGrid(items: [
              MapEntry("Total", formatCurrency(l['summary']['totalAmount'])),
              MapEntry("Active", (l['summary']['activeCount'] ?? 0).toString()),
              MapEntry("Interest Paid", formatCurrency(l['summary']['totalInterestPaid'])),
              MapEntry("Interest Due", formatCurrency(l['summary']['totalInterestDue'])),
            ]),
            if (list.isEmpty)
