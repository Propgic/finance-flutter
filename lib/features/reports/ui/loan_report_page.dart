        ...
        return ListView(
          children: [
            ReportSummaryGrid(items: [
              ...
              MapEntry("Principal", formatCurrency(l['summary']['totalPrincipal'])),
              MapEntry("Outstanding", formatCurrency(l['summary']['totalOutstanding'])),
              MapEntry("Collected", formatCurrency(l['summary']['totalCollected'])),
            ]),
            if (list.isEmpty)
