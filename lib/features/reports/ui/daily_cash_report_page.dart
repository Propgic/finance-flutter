...
class DailyCashReportPage extends StatelessWidget {
        ...
        return ListView(
          children: [
            ReportSummaryGrid(items: [
              MapEntry("Collections", formatCurrency(l['summary']['collections'])),
              MapEntry("Disbursements", formatCurrency(l['summary']['disbursements'])),
              MapEntry("Expenses", formatCurrency(l['summary']['expenses'])),
              MapEntry("Net Cash", formatCurrency(l['summary']['netCash'])),
            ]),
            if (list.isEmpty)
